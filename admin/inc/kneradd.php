...
<div id="form-wrapper">
	<div id="steps">
	<fieldset class="step">
		<input type=hidden name='type' value='kner'>
...
<!-- ----------------------------------------------------------------------------------------------------------------------- -->
	...
	<fieldset class="step">
		...
		<table cellpadding=2 cellspacing=1 width="98%">
			<tr>
				<td width="35%">Тип будівлі</td>
				<td>
					<select name='office_type' style="width:250px;">
					<? foreach ($sys['lists']['office_type'] as $key){?>
						<option value="<?=$key?>" <?if ($obj->office_type==$key){?>selected="selected"<?}?>><?=$key?></option>
					<? } ?>
					</select>
				</td>
			</tr>
   ...
   <!-- ----------------------------------------------------------------------------------------------------------------------- -->
	...
	<fieldset class="step">
          ...
          <center>Фото об'єкта (максимальний розмір картинки - 1024х768/2Mb)</center><BR />
