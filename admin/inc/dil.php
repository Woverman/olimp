...
?>
<div style="border:1px dotted green;height:20px;margin:4px;padding:4px" id='sdiv'><div onclick="ShowHideDiv('findforms');" style="cursor:pointer;float:left" width=50%><button>Відбір &#8595;</button></div><div style="float:right;"><button onclick="window.location='area_edit.php?panel=diladd';">Додати</button></div></div>
<?php
...
<tr bgcolor=#BDCACC><th rowspan=2>№</th><th colspan=2>Місто</th><th>Площа</th><th>Ціна</th><th>Правка</th></tr>
<tr bgcolor=#BDCACC><th>Вулиця</th><th>Власність</th><th>Оголош.</th><th>Агент</th><th>Знищити</th></tr>
<?php
	$a=1;
  ...
  if ($page=='all')
    ...
    echo '<td>'.$row['adr_vul'].'</td>';
		...
		echo '<td><a href="obj_del.php?id='.$row['id'].'" onclick="return confirm(\'Знищити ділянку?\')"><img class=aimg src="./i/del.gif"></a></td>';
