...
if (!empty($_GET["result"])){
	?>
	<div id="succesInfo" style="border:1px solid green; height:1em; margin:4px; padding:14px; font-weight:bold;" align="center">Інформація про об'єкт успішно збережена</div>
...
<?php
    ...
    $params = '&nomer='.$nomer.'&agent='.$agent.'&obl='.$obl.'&rgn='.$rgn.'&mista='.$mista;
		echo '<td rowspan=2><a href="/admin/kneradd/?oid='.$row['id'].$params.'">';
