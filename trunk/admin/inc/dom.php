...
if (!empty($_GET["result"])){
	?>
	<div id="succesInfo" style="border:1px solid green; height:1em; margin:4px; padding:14px; font-weight:bold;" align="center">Інформація про будинок успішно збережена</div>
