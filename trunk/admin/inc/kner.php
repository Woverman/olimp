...
if (!empty($_GET["result"])){
	$txt = ($_GET["result"]==1?"Інформація про об'єкт успішно збережена":"Об'єкт видалено");
	?>
...
<th>№</th><th>Огол.</th><th>Місто</th><th>Вулиця</th><th>Кімнат</th><th>Площі</th><th>Поверх</th><th>Агент</th><th>Ціна</th><th>Операції</th></tr>
<?php
	$a=1;
	...
	while ($row=mysql_fetch_array($res)){
		...
		echo '<td><a href="/admin/kneradd/?oid='.$row['id'].$params.'">';
		echo '<img class=aimg src="/i/edit.png" style="cursor:pointer;border:0">';
		echo '<a href="/index.php?page=admin&panel=delobj&oid='.$row['id'].'" onclick="return confirm(\'Знищити об`єкт?\')">';
