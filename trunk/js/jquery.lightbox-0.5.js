...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'/i/lb/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'/i/lb/back.png',			// (string) Path and the name of the prev button image
			imageBtnNext:			'/i/lb/next.png',			// (string) Path and the name of the next button image
			imageBtnClose:			'/i/lb/close.png',		// (string) Path and the name of the close btn
			imageBlank:				'/i/lb/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			if (intImageWidth > intImageHeight && ((intImageHeight/intImageWidth)*($(window).width()-100))<$(window).height()) {
		        intImageHeight = (intImageHeight/intImageWidth)*($(window).width()-300);
		        intImageWidth = $(window).width()-300;
		        $('#lightbox-image').css({ width: $(window).width()-300,height:'auto' });
		        var intCurrentWidth = $(window).width()-300;
			} else {
		        intImageWidth = (intImageWidth/intImageHeight)*($(window).height()-100);
		        intImageHeight = $(window).height()-100;
		        $('#lightbox-image').css({ height: $(window).height()-100,width: 'auto' });
		        var intCurrentWidth = $(window).height()-100;
			}
